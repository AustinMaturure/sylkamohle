    ...
    <>
      ...
      <section className="hero" style={{ backgroundImage: `url(${skyImage})` }}>
        <div className="hero-title">
          ...
          <p className="tag">
            So you can see more of what's important in life.
          </p>
        </div>
      </section>
      <section className="offer">
        <div className="offer-content" id="services">
          ...
          <div className="grid-1" ref={serviceCardRef}>
            ...
            <div className="service-card" id="card-2">
              ...
              <p className="service-description" style={{ marginTop: "0px" }}>
                ...
                variety of colors, so you can look good at every occasion,
          ...
          <div className="grid-2">
            <Link
              to={`/services/prescription-eyeglasses`}
              className="service-link"
            >
              <div className="service-card" id="card-4">
                ...
                <p className="service-description" style={{ marginTop: "0px" }}>
                  ...
                  in selecting eyeglass frames and fitting contact lenses. With
                  our wide range of well-known brands we ensure you not only see
                  great, but look great too.
                </p>
                <div className="arrow-cnt">
                  <div>
                    <p className="rd-mre">read more</p>
            ...
            <div className="service-card" id="card-5">
              ...
              <p className="service-description" style={{ marginTop: "0px" }}>
                ...
                own frame into sunglasses, combining the best of style, comfort
                and protection.
              </p>
            </div>
            ...
            <div className="service-card" id="card-6">
              ...
              <p className="service-description">
                Providing necessary eye test results needed for both writing the
                Learners Liscence test and Drivers test.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="about-text">
              ...
              <div className="about-rep">
                <h3 className="about-qa-rep text-bubble right-triangle">
                  ...
                  enjoyable life. We take pride in helping you see the things
                  you love, ensuring your journey is clear, comfortable, and
              ...
              <div className="about-rep">
                <h3 className="about-qa-rep text-bubble right-triangle">
                  ...
                  you'll experience a seamless process from check-in to your eye
                  examination, with a focus on your comfort and well-being
                </h3>
              </div>
            </div>
          </div>
        ...
        <section className="contact-us" id="contact-us" ref={contactImageRef}>
            ...
            <address>
              ...
              <div className="c-info">
                ...
                >
                  CALL TO BOOK{" "}
                  <FontAwesomeIcon
                    icon={clicked ? faClipboardCheck : faClipboard}
                    className="btn-copy"
                    style={{
                      marginLeft: "8px",
                      transition: "all 1s",
          ...
          <div className="contact-image-cnt">
            <img
              ...
              style={{ maxWidth: "100%" }}
              src={contactImage}
              alt="optometrist piet retief holding glasses"
              loading="lazy"
            />
          </div>
        </section>
